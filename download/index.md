...
* Current Stable Release (1.10.4) <a class="btn btn-default" href="http://download.osgeo.org/pycsw/pycsw-1.10.4.tar.gz">tar.gz <span class="glyphicon glyphicon-compressed"> </span></a> <a class="btn btn-default" href="http://download.osgeo.org/pycsw/pycsw-1.10.4.zip">zip <span class="glyphicon glyphicon-compressed"> </span></a>

* Current Development Release (2.0.0-alpha1) <a class="btn btn-default" href="http://download.osgeo.org/pycsw/pycsw-2.0.0-alpha1.tar.gz">tar.gz <span class="glyphicon glyphicon-compressed"> </span></a> <a class="btn btn-default" href="http://download.osgeo.org/pycsw/pycsw-2.0.0-alpha1.zip">zip <span class="glyphicon glyphicon-compressed"> </span></a>
