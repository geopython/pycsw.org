...
* Current Stable Release (1.6.2) <a class="btn btn-default" href="http://download.osgeo.org/pycsw/pycsw-1.6.2.tar.gz">tar.gz <span class="glyphicon glyphicon-compressed"> </span></a> <a class="btn btn-default" href="http://download.osgeo.org/pycsw/pycsw-1.6.2.zip">zip <span class="glyphicon glyphicon-compressed"> </span></a>
